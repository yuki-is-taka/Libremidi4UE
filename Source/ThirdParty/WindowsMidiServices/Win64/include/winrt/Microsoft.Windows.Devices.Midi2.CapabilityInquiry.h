...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::Devices::Midi2::CapabilityInquiry::IMidiUniqueIdStatics)->get_ShortLabelPlural(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::Devices::Midi2::CapabilityInquiry::IMidiUniqueIdStatics)->get_LongLabelPlural(&value));
        return hstring{ value, take_ownership_from_abi };
    }
